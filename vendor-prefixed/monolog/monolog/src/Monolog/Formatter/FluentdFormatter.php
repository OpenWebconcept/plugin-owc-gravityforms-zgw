...
namespace OWCGravityFormsZGW\Vendor_Prefixed\Monolog\Formatter;
 ...
 * Monolog setup:
 *
 * $logger = new \OWCGravityFormsZGW\Vendor_Prefixed\Monolog\Logger('fluent.tag');
 * $fluentHandler = new \OWCGravityFormsZGW\Vendor_Prefixed\Monolog\Handler\SocketHandler('unix:///var/run/td-agent/td-agent.sock');
 * $fluentHandler->setFormatter(new \OWCGravityFormsZGW\Vendor_Prefixed\Monolog\Formatter\FluentdFormatter());
