 ...
 *
 *      $logger = new \OWCGravityFormsZGW\Vendor_Prefixed\Monolog\Logger('all', array(new \OWCGravityFormsZGW\Vendor_Prefixed\Monolog\Handler\PHPConsoleHandler()));
...
class PHPConsoleHandler extends AbstractProcessingHandler
{
    ...
    private array $options = [
        ...
        'classesPartialsTraceIgnore' => ['OWCGravityFormsZGW\\Vendor_Prefixed\\Monolog\\'], // array Hide calls of classes started with...
