...
use DateTimeZone;
use Fiber;
use OWCGravityFormsZGW\Vendor_Prefixed\Monolog\Handler\HandlerInterface;
use OWCGravityFormsZGW\Vendor_Prefixed\Monolog\Processor\ProcessorInterface;
use OWCGravityFormsZGW\Vendor_Prefixed\Psr\Log\LoggerInterface;
use OWCGravityFormsZGW\Vendor_Prefixed\Psr\Log\InvalidArgumentException;
...
class Logger implements LoggerInterface, ResettableInterface
{
     ...
     *
     * @throws \OWCGravityFormsZGW\Vendor_Prefixed\Psr\Log\InvalidArgumentException If level is not defined
     *
     * @phpstan-param  value-of<Level::VALUES>|Level $level
