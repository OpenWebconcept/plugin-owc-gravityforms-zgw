...
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\FactoryDefinition;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\Helper\DefinitionHelper;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\InstanceDefinition;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\ObjectDefinition;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\Resolver\DefinitionResolver;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\Resolver\ResolverDispatcher;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\Source\DefinitionArray;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\Source\MutableDefinitionSource;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\Source\ReflectionBasedAutowiring;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\Source\SourceChain;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\ValueDefinition;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Invoker\DefinitionParameterResolver;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Proxy\NativeProxyFactory;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Proxy\ProxyFactory;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Proxy\ProxyFactoryInterface;
use InvalidArgumentException;
use OWCGravityFormsZGW\Vendor_Prefixed\Invoker\Invoker;
use OWCGravityFormsZGW\Vendor_Prefixed\Invoker\InvokerInterface;
use OWCGravityFormsZGW\Vendor_Prefixed\Invoker\ParameterResolver\AssociativeArrayResolver;
use OWCGravityFormsZGW\Vendor_Prefixed\Invoker\ParameterResolver\Container\TypeHintContainerResolver;
use OWCGravityFormsZGW\Vendor_Prefixed\Invoker\ParameterResolver\DefaultValueResolver;
use OWCGravityFormsZGW\Vendor_Prefixed\Invoker\ParameterResolver\NumericArrayResolver;
use OWCGravityFormsZGW\Vendor_Prefixed\Invoker\ParameterResolver\ResolverChain;
...
class Container implements ContainerInterface, FactoryInterface, InvokerInterface
{
     ...
     *                             The array can also contain DI definitions, e.g. \OWCGravityFormsZGW\Vendor_Prefixed\DI\get().
     *
