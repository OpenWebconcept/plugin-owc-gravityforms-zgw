...
use function chmod;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\ArrayDefinition;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\DecoratorDefinition;
...
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\Source\DefinitionSource;
...
use OWCGravityFormsZGW\Vendor_Prefixed\DI\DependencyException;
use OWCGravityFormsZGW\Vendor_Prefixed\DI\Proxy\ProxyFactoryInterface;
use function dirname;
use function file_put_contents;
use InvalidArgumentException;
use OWCGravityFormsZGW\Vendor_Prefixed\Laravel\SerializableClosure\Support\ReflectionClosure;
use function rename;
    ...
    private function compileDefinition(string $entryName, Definition $definition) : string
    {
        ...
        switch (true) {
            ...
            case $definition instanceof StringDefinition:
                ...
                $code = 'return \OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\StringDefinition::resolveExpression(' . $entryName . ', ' . $expression . ', $this->delegateContainer);';
                break;
            case $definition instanceof EnvironmentVariableDefinition:
                ...
                $code = <<<PHP
                            ...
                            if (!$isOptional) {
                                throw new \OWCGravityFormsZGW\Vendor_Prefixed\DI\Definition\Exception\InvalidDefinition("The environment variable '{$definition->getVariableName()}' has not been defined");
                            }
                            return $defaultValue;
                    PHP;
                break;
